...
(function() {
    ...
    Game_Interpreter.prototype.pluginCommand = function(command, args) {
        ...
        if (command === 'Test') {
            switch (args[0]) {
            case 'hoge':
                $gameSystem.testCommand();
                break;
            }
        }
    };
    Game_System.prototype.testCommand = function() {
      console.debug("hoge called");
      var socket = io.connect('http://localhost:3030', {transports:["websocket"]});
      socket.on('connect', function(msg) {
        console.debug("connected");
      });
      console.debug("a");
    };
    Game_System.prototype.onOpen = function(evt) {
      console.debug("on open");
    }
    Game_System.prototype.onError = function(evt) {
      console.debug("on error" + evt.data);
    }
})();
